...
function PasswordChecker({
    ...
    const passwordStrength = () => {
        if (checkPass(password).score === 0) {
            ...
            return 'The password is weak.' + '\n' + 'Please enter a password that is at least 6 characters long, that has at least one uppercase and lowercase letter and a number.'
        } else if (checkPass(password).score === 3 || checkPass(password).score === 4) {
            return 'The password is medium.' + '\n' + 'If you want to strengthen your password: enter a password that is at least 6 characters long, that has at least one uppercase and lowercase letter and a number.'
